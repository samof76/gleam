...
-spec push_key({ok, AUJ} | {error, get_error()}, binary()) -> {ok, AUJ} |
    {error, get_error()}.
push_key(Result, Key) ->
    case Result of
        {ok, T} ->
...
-spec expect_end_of_line(
    list(binary()),
    fun((list(binary())) -> {ok, {AWO, list(binary())}} | {error, parse_error()})
) -> {ok, {AWO, list(binary())}} | {error, parse_error()}.
...
-spec do(
    {ok, {AWZ, list(binary())}} | {error, parse_error()},
    fun((AWZ, list(binary())) -> {ok, AXC} | {error, parse_error()})
) -> {ok, AXC} | {error, parse_error()}.
do(Result, Next) ->
    case Result of
        {ok, {A, Input}} ->
            Next(A, Input);
...
-spec expect(
    list(binary()),
    binary(),
    fun((list(binary())) -> {ok, {AXH, list(binary())}} | {error, parse_error()})
) -> {ok, {AXH, list(binary())}} | {error, parse_error()}.
