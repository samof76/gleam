...
-type pool(BQG, BQH) :: {pool,
        fun((glisten@internal@handler:loop_message(BQG), BQH, glisten@internal@handler:connection(BQG)) -> gleam@otp@actor:next(glisten@internal@handler:loop_message(BQG), BQH)),
        integer(),
        fun((glisten@internal@handler:connection(BQG)) -> {BQH,
            gleam@option:option(gleam@erlang@process:selector(BQG))}),
        gleam@option:option(fun((BQH) -> nil)),
        glisten@transport:transport()}.
