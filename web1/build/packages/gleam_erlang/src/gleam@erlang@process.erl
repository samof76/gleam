...
-spec try_call_forever(subject(FSE), fun((subject(FSG)) -> FSE)) -> {ok, FSG} |
...
-spec call_forever(subject(FSA), fun((subject(FSC)) -> FSA)) -> FSC.
...
-file("/Users/louis/src/gleam/erlang/src/gleam/erlang/process.gleam", 688).
...
-spec send_after(subject(FSN), integer(), FSN) -> timer().
...
-file("/Users/louis/src/gleam/erlang/src/gleam/erlang/process.gleam", 724).
...
-file("/Users/louis/src/gleam/erlang/src/gleam/erlang/process.gleam", 776).
...
-file("/Users/louis/src/gleam/erlang/src/gleam/erlang/process.gleam", 804).
-spec register(pid_(), gleam@erlang@atom:atom_()) -> {ok, nil} | {error, nil}.
register(Pid, Name) ->
    gleam_erlang_ffi:register_process(Pid, Name).

-file("/Users/louis/src/gleam/erlang/src/gleam/erlang/process.gleam", 815).
...
-file("/Users/louis/src/gleam/erlang/src/gleam/erlang/process.gleam", 838).
